...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className="flex items-center border border-[#E9EAEB] bg-white shadow-[0_1px_2px_0_rgba(10,13,18,0.05)] 
      p-4 sm:p-6 rounded-2xl">
      
      <div className="flex flex-col gap-6 sm:gap-8">
        {/* Icon */}
        <div
          className={`p-3 sm:p-4 rounded-full ${cardColor.split(" ")[0]}`}
        >
          {icon}
        </div>
