    ...
    <div className="min-h-screen bg-gray-50 ">
      <div className="max-w-5xl mx-auto px-4">
            ...
            <div>
              ...
              <ul className="text-blue-800 space-y-2">
                <li className="flex items-start">
                  ...
                  <span>
                    In den nächsten 5-10 Minuten erhalten Sie eine
                    Bestätigungs-E-Mail von Wechselsicher.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>
                    Innerhalb von 1-2 Werktagen erhalten Sie die
                    Vertragsunterlagen direkt vom neuen Anbieter.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>
                    ...
                    E-Mail erhalten sollten.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>
                    Ihr bisheriger Vertrag wird automatisch gekündigt.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 text-center text-gray-500 text-sm">
          <p className="mb-2">Haben Sie Fragen zu Ihrer Bestellung?</p>
          <p>
            Kontaktieren Sie uns unter{" "}
            <a
              href="mailto:support@wechselsicher.de"
