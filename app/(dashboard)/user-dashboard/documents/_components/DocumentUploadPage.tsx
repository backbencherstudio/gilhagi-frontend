...
const DOCUMENTS: Document[] = [
  { id: "1", title: "Old Contract", status: "pending" },
  { id: "2", title: "SEPA Direct Debit Mandate", status: "pending" },
  { id: "3", title: "Power of Attorney", status: "pending" },
  { id: "4", title: "Photo of The Meter", status: "pending" },
];
              ...
              {documents.map((doc, index) => (
                <div
                  ...
                  className={`flex-1 h-2 rounded-full transition-all duration-500 ${
                    index < uploadedCount
                      ? "bg-[#085EC4]" // Active segment
                      : "bg-[#CCDAE4]" // Inactive segment
                  }`}
                />
              ))}
            </div>
