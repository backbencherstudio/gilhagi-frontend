...
export default function CurrentContract() {
  return (
    <div className="space-y-8 self-stretch border border-[#E9E9EA] [background:#FFF] shadow-[0_1px_2px_0_rgba(10,13,18,0.05)] p-5 rounded-2xl border-solid ">
      {/* first div */}
      <div className=" flex items-center justify-between w-full">
        <div>
          <p className="self-stretch text-[#1C2022]  text-lg font-semibold leading-[160%]">
            Aktueller Vertrag
          </p>
      ...
      {/* second div */}
      <div className=" space-y-6 self-stretch border border-[#E9E9EA] [background:var(--BG-soft,#F8FCFD)] p-5 rounded-lg border-solid ">
